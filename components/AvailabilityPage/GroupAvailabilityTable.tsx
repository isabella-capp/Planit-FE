...
import { CalendarDays, CheckCircle, Clock, UserCheck } from 'lucide-react';
...
const GroupAvailabilityTable: React.FC<GroupAvailabilityTableProps> = ({
  ...
  return (
    <div className="flex flex-col gap-3 justify-center items-center m-10 text-sm">
      {isCreator && (
        <div className="flex flex-col justify-center gap-2">
          <div className="w-full max-w-3xl mb-4">
            <button
              onClick={toggleSelectionMode}
              className={`flex justify-center items-center gap-2 px-4 py-2 rounded-md font-medium ${selectionMode ? "bg-red-500 hover:bg-red-600 text-white" : "bg-primary hover:bg-primary-dark text-white"
                } transition-colors`}
            >
