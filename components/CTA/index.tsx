          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join With Us & Increase Your Productivity
              </h2>
              <p>
                Planit offers a fast, intuitive, and free experience. Sign up today and make organizing your next event easier than ever!
              </p>
            </motion.div>
            <motion.div
              variants={{
