    ...
    <section className="px-2 sm:px-4 md:px-8 2xl:px-0 min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Available Participants</p>
                  <p className="text-base text-gray-900 dark:text-white">
                    {availableUsers.length > 0 ? availableUsers.join(", ") : "No participants available at this time"}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 text-center text-gray-500 dark:text-gray-400">
          <p>All participants will be notified of the final schedule.</p>
        </div>
      </div>
    </section>
  )
